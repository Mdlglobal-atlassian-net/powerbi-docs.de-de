...
1. [Erstellen Sie in **Power BI Desktop** Measures in Ihrem Datenmodell](../transform-model/desktop-tutorial-create-measures.md). Veröffentlichen Sie das Datenmodell dann mithilfe des **Power BI-Diensts**. Greifen Sie dann aus Excel auf das veröffentlichte Dataset zu.
