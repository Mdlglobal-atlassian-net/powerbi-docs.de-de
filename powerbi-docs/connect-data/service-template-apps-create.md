...
- [Power BI Pro-Lizenz](../fundamentals/service-self-service-signup-for-power-bi.md)
- [Installation von Power BI Desktop](../fundamentals/desktop-get-the-desktop.md) (optional)
- Vertrautheit mit den [grundlegenden Konzepten von Power BI](../fundamentals/service-basic-concepts.md)
- Berechtigungen zum Freigeben einer Vorlagen-App für die Öffentlichkeit (weitere Informationen finden Sie im [Power BI-Verwaltungsportal in den Einstellungen für Vorlagen-Apps](../admin/service-admin-portal.md#template-apps-settings))
...
1. Klicken Sie im Vorlagen-Arbeitsbereich auf **App erstellen**.
    ...
    **Navigation**
    ...
    Aktivieren Sie den **Neuen Navigations-Generator**, in dem Sie den Navigationsbereich definieren können (Weitere Informationen finden Sie in diesem Artikel unter [Entwerfen der Navigation](../collaborate-share/service-create-distribute-apps.md#design-the-navigation-experience)).
...
10. Wenn Sie bereit sind, Ihre App in die Präproduktionsphase höherzustufen, um Tests außerhalb Ihres Mandanten durchzuführen, wechseln Sie zurück in den **Release Management**-Bereich, und wählen Sie **Promote app** (App höher stufen) aus. 
    ...
    Wenn diese Option nicht angezeigt wird, kontaktieren Sie Ihren Power BI-Administrator, damit er Ihnen im Verwaltungsportal [Berechtigungen für die Entwicklung von Vorlagen-Apps](../admin/service-admin-portal.md#template-apps-settings) gewährt.
