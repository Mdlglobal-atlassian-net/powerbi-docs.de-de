...
Für diesen Codeausschnitt wird angenommen, dass sich das im Pushverfahren übertragbare Dataset bereits in einem Arbeitsbereich in der SaaS-Umgebung befindet. Informationen über die Push-API finden Sie unter [Übertragen von Daten in ein Power BI-Dataset per Push](../automation/walkthrough-push-data.md).
...
[Power BI Premium – Beschreibung](../../admin/service-premium-what-is.md)  
