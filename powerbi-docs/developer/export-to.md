...
Ein Auftrag, bei dem die Anzahl von gleichzeitigen Anforderungen überschritten ist, wird nicht abgeschlossen. Wenn Sie beispielsweise drei Seiten in einer A1-SKU exportieren, wird der erste Auftrag ausgeführt, und die beiden anderen warten auf die nächsten beiden Ausführungszyklen.
...
* Der Bericht, den Sie exportieren möchten, muss sich in einer Kapazität befinden.
* Das Dataset des Berichts, den Sie exportieren möchten, muss sich in einer Kapazität befinden.
