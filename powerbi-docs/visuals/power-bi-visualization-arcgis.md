...
Sehen Sie sich an, wie Will verschiedene Visualisierungen erstellt, und probieren Sie es dann anhand der PBIX-Datei zum [Analysebeispiel für Einzelhandel](../create-reports/sample-datasets.md) selbst aus.
