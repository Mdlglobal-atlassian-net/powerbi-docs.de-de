...
## <a name="quick-review-of-terminology"></a>Kurze Terminologieübersicht
...
![grüner Kreis](media/end-user-license/power-bi-green-dot.png): Die Funktion ist im aktuellen Szenario verfügbar.    
![orangefarbenes X](media/end-user-features/orange-x.png): Die Funktion ist im aktuellen Szenario nicht verfügbar.    
 **![grünes MWO](media/end-user-features/green-mwo.png)**: Die Funktion ist nur in **Mein Arbeitsbereich** verfügbar. Inhalte in **Mein Arbeitsbereich** sind nur für den persönlichen Gebrauch des Besitzers gedacht und können von anderen Benutzern in Power BI nicht angezeigt oder für diese freigegeben werden.    
 \* Der Zugriff auf diese Funktion kann von einem Benutzer mit Pro-Lizenz oder einem Administrator aktiviert oder deaktiviert werden.    
 <br><br>
...
|Öffnen | ![orangefarbenes X](media/end-user-features/orange-x.png) | ![grüner Kreis](media/end-user-license/power-bi-green-dot.png)  | 
|Favorit | ![orangefarbenes X](media/end-user-features/orange-x.png) | ![grüner Kreis](media/end-user-license/power-bi-green-dot.png)  |
 |Bearbeiten, aktualisieren, erneut freigeben, erneut veröffentlichen |![orangefarbenes X](media/end-user-features/orange-x.png)  |![orangefarbenes X](media/end-user-features/orange-x.png)   |
 |Neue Rolle erstellen |![orangefarbenes X](media/end-user-features/orange-x.png)  |![orangefarbenes X](media/end-user-features/orange-x.png)   |
 |AppSource: herunterladen und öffnen | ![orangefarbenes X](media/end-user-features/orange-x.png)  |![orangefarbenes X](media/end-user-features/orange-x.png) | 
|Store der Organisation: herunterladen und öffnen|![orangefarbenes X](media/end-user-features/orange-x.png)  |![grüner Kreis](media/end-user-license/power-bi-green-dot.png)  |
 |**App-Arbeitsbereiche**
| Arbeitsbereiche oder Inhalte erstellen, bearbeiten oder löschen  | ![orangefarbenes X](media/end-user-features/orange-x.png)  |![orangefarbenes X](media/end-user-features/orange-x.png) |
|Endorsements hinzufügen | ![orangefarbenes X](media/end-user-features/orange-x.png)  |![orangefarbenes X](media/end-user-features/orange-x.png) | 
|Öffnen und anzeigen  |  ![orangefarbenes X](media/end-user-features/orange-x.png) |  ![grüner Kreis](media/end-user-license/power-bi-green-dot.png)  | 
| Lesen von in Arbeitsbereichs-Datenflüssen gespeicherten Daten |![orangefarbenes X](media/end-user-features/orange-x.png) |![grüner Kreis](media/end-user-license/power-bi-green-dot.png)|
|**Dashboards**
|Dashboards von Kollegen empfangen, anzeigen und mit ihnen interagieren | ![orangefarbenes X](media/end-user-features/orange-x.png) |  ![grüner Kreis](media/end-user-license/power-bi-green-dot.png)  | 
| Warnungen zu Kacheln hinzufügen  |  ![grünes MWO](media/end-user-features/green-mwo.png) |  ![grüner Kreis](media/end-user-license/power-bi-green-dot.png)  | 
| Kommentare von anderen anzeigen und beantworten: eigene Kommentare hinzufügen  |  ![orangefarbenes X](media/end-user-features/orange-x.png) |  ![grüner Kreis](media/end-user-license/power-bi-green-dot.png)*  | 
| Kopie speichern | ![grünes MWO](media/end-user-features/green-mwo.png) |![orangefarbenes X](media/end-user-features/orange-x.png) | 
|Visual als Bild kopieren? |![grünes MWO](media/end-user-features/green-mwo.png) |![grüner Kreis](media/end-user-license/power-bi-green-dot.png)|
|Erstellen, bearbeiten, aktualisieren, löschen | ![grünes MWO](media/end-user-features/green-mwo.png) |![orangefarbenes X](media/end-user-features/orange-x.png) | 
|Kachel zu Excel exportieren |![grünes MWO](media/end-user-features/green-mwo.png) | ![grüner Kreis](media/end-user-license/power-bi-green-dot.png)|
...
|  Filter: Typen ändern  |![grünes MWO](media/end-user-features/green-mwo.png)* |![grüner Kreis](media/end-user-license/power-bi-green-dot.png)* |
