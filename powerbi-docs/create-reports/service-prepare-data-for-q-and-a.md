...
* Wenn die Arbeitsmappe ein PowerPivot-Datenmodell aufweist, können Sie noch mehr Optimierungen durchführen. Unter [Demystifying Power BI Q&A Part 2](https://powerbi.microsoft.com/blog/demystifying-power-bi-q-amp-a-part-2/) erhalten Sie von unserem Expertenteam für natürliche Sprachen weitere Informationen.
...
- [Abrufen von Daten (für Power BI)](../connect-data/service-get-data.md)  
