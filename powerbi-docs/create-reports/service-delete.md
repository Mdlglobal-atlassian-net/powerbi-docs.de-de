...
* Wenn ein Dashboard zu einem [organisationsbezogenen Inhaltspaket](../collaborate-share/service-organizational-content-pack-disconnect.md) gehört, ist die einzige Möglichkeit zum Entfernen das Entfernen des verknüpften Datasets.
...
3. Bestätigen Sie den Löschvorgang.
   ...
   > [!NOTE]
   > Ist der Bericht Teil eines [Inhaltspakets](../collaborate-share/service-organizational-content-pack-introduction.md), können Sie ihn mit dieser Methode nicht löschen.  Siehe [Entfernen der Verbindung mit einem organisationsbezogenen Inhaltspaket in Power BI](../collaborate-share/service-organizational-content-pack-disconnect.md).
   >
   >
...
2. Suchen Sie die zu löschende Arbeitsmappe, und wählen Sie das Symbol zum Löschen  ![Symbol „Löschen“](media/service-delete/power-bi-delete-report2.png) klicken.
...
* [Entfernen eines ausgewählten Dashboards](../consumer/end-user-featured.md)
* [Entfernen eines Dashboards aus den Favoriten](../consumer/end-user-favorite.md)
